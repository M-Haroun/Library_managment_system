...
class Book(models.Model):
    ...
    profit_ratio = models.DecimalField(max_digits=8, decimal_places=2,null=True,  blank=True)
    profits = models.DecimalField(max_digits=8, decimal_places=2,null=True,  blank=True)
    ...
    retal_total = models.DecimalField(max_digits=8, decimal_places=2,null=True,  blank=True)
